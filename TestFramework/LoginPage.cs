...
namespace TestFramework
{
	public class LoginPage
	{
		...
		{
			Driver.Instance.Navigate().GoToUrl("http://localhost:8080/wordpress/wp-admin/");
			//After we navigate to URL, wait untile the page having an ID "user_login" is seen. This is id for loginName text box. 
